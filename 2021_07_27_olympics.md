...
```
    ...
    ## Only 10 Github queries remaining until 2021-08-04 05:25:34 PM BST.
    ...
    ## Only 9 Github queries remaining until 2021-08-04 05:25:34 PM BST.

    ##  Downloading file 2 of 2: `regions.csv`

    ## Only 8 Github queries remaining until 2021-08-04 05:25:34 PM BST.
...
ragg::agg_png(here::here("render/olympics.png", width = 4000, height = 2400, scaling = 4)) 
```

    ## Warning: Arguments must be unnamed

    ## Warning in dir.create(dir, recursive = TRUE): cannot create dir 'C:
    ## \Users\rmkja\Documents\Coding\tidy_tuesday\render\olympics.png\4000', reason 'No
    ## such file or directory'

    ## Warning in normalizePath(path.expand(path), winslash, mustWork): path[1]="C:/
    ## Users/rmkja/Documents/Coding/tidy_tuesday/render/olympics.png/4000/2400": The
