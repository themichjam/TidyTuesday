...
final <- drought %>%
  ...
  labs(title = "Evolution of droughts in the US over the last 20 years",
       ...
       caption = "Visualization: Michelle K Jamieson | @themichjam | Data: Drought Monitor")+
  theme_void()+
...
```{r save}
ragg::agg_png(here::here("render", "droughts.png"), res = 320, width = 18, height = 12, units = "in")
